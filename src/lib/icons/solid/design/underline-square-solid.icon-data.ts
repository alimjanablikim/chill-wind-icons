...
export const underlineSquareSolidIconData: IconData = {
  ...
  category: 'design',
  viewBox: '0 0 24 24',
  innerSvg: `<path fill="currentColor" fill-rule="evenodd" d="M2.25 3.6c0-.746.604-1.35 1.35-1.35h16.8c.746 0 1.35.604 1.35 1.35v16.8a1.35 1.35 0 0 1-1.35 1.35H3.6a1.35 1.35 0 0 1-1.35-1.35zM8 5.25a.75.75 0 0 1 .75.75v4a3.25 3.25 0 0 0 6.5 0V6a.75.75 0 0 1 1.5 0v4a4.75 4.75 0 1 1-9.5 0V6A.75.75 0 0 1 8 5.25m-2 12a.75.75 0 0 0 0 1.5h12a.75.75 0 0 0 0-1.5z" clip-rule="evenodd"/>`,
